...
text = button label
variant = primary | secondar | tertiary
size = large | small
...
| `iconPosition` | `icon-position` | Icon position: - left - right                                   | `"left" \| "right"`                      | `'left'`    |
...
| `variant`      | `variant`       | Button variant: - primary - seconday - tertiary                 | `"tertiary" \| "primary" \| "secondary"` | `'primary'` |
